		...
		<div class="container flex items-center justify-between">
            <div class="w-full flex justify-between items-center">
                <a href="<?php echo esc_url(home_url('/')); ?>">
                    ...
                    ); ?>/assets/imgs/logo.webp" alt="5 FIVEX Store" />
                    </a>
                <div class="lg:hidden">
